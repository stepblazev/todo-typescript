...
const topicTemplate: string = `<div class="topic hoverable">
<div class="topic__header">
    <button class="topic__mark">
        <svg class="icon-not-marked" viewBox="0 0 48 48" width="48"
            xmlns="http://www.w3.org/2000/svg">
            <path
                d="M34 6H14c-2.21 0-3.98 1.79-3.98 4L10 42l14-6 14 6V10c0-2.21-1.79-4-4-4zm0 30l-10-4.35L14 36V10h20v26z" />
            <path d="M0 0h48v48H0z" fill="none" />
        </svg>
        <svg class="icon-marked" height="48" viewBox="0 0 48 48" width="48"
            xmlns="http://www.w3.org/2000/svg">
            <path
...
<div class="topic__more">
    ...
    <button class="topic__show-more">
        <svg enable-background="new 0 0 80 80" height="80px" id="Icons" version="1.1"
            viewBox="0 0 80 80" width="80px" xml:space="preserve"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <polygon
                points="61,37 43,37 43,19 37,19 37,37 19,37 19,43 37,43 37,61 43,61 43,43 61,43 " />
        </svg>
    </button>
</div>
<div class="tasks">
    <ul class="tasks__list">
        <li>
            <svg class="icon-wait" id="Icons" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <path class="cls-1"
            ...
            <svg class="icon-checked" height="24" viewBox="0 0 24 24" width="24"
                xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <li>
            ...
            <span>Go to the grocery store</span>
            <button class="tasks__delete">
                <svg id="Layer_2" style="enable-background:new 0 0 32 32;" version="1.1"
                    viewBox="0 0 32 32" xml:space="preserve"
                    xmlns="http://www.w3.org/2000/svg"
